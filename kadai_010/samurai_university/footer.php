               ...
               <div class="col-lg-4 footer_col">
                 <div class="footer_section footer_about">
                   <div class="footer_logo_container">
                     <img src="<?php echo get_template_directory_url();?>/images/logo_big.png" alt="" />
                     <a href="">
   ...
   <!--jQuery-->
   <script src="<?php echo get_template_directory_url();?>/js/jquery-3.2.1.min.js"></script>
   <script src="<?php echo get_template_directory_url();?>/styles/bootstrap4/popper.js"></script>
   <script src="<?php echo get_template_directory_url();?>/styles/bootstrap4/bootstrap.min.js"></script>
